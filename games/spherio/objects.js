...
function Player(x, y) {
  ...
  this.show = function() {
    ...
    }else if(this.skin == "purple"){
      fill(115 + this.color, this.color, 255)
    }else if(this.skin == "blue"){
      fill(this.color, this.color, 255)
    }else if(this.skin == "green"){
      fill(this.color, 255, this.color)
    }else if(this.skin == "orange"){
      fill(255, 149 + this.color, this.color)
...
function Goal(x, y, s) {
  ...
  this.show = function() {
    ...
    if (s == 0) {
      if(p.skin == "red"){
    stroke(255, this.color, this.color);
    }else if(p.skin == "purple"){
      stroke(115 + this.color, this.color, 255)
    }else if(p.skin == "blue"){
      stroke(this.color, this.color, 255)
    }else if(p.skin == "green"){
      stroke(this.color, 255, this.color)
    }else if(p.skin == "orange"){
      stroke(255, 149 + this.color, this.color)
...
for(let i = 0; i < 5; i++){
    colorButtons[i] = new Button(colors[i], (w / 5) + (i * w / 8), h / 2, w / 10, h / 15, 13, true)
}  
